...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  controller.o generat.o heater.o register.o tempsensor.o transduc.o queue.o main.o cpu.o distri.o com.o linpack.o debug.o trafico.o
#B
...
#^|
controller.o: /cygdrive/C/eclipse/workspace/HouseHeatSystem/controller.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
generat.o: /cygdrive/C/eclipse/workspace/HouseHeatSystem/generat.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
heater.o: /cygdrive/C/eclipse/workspace/HouseHeatSystem/heater.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/HouseHeatSystem/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
tempsensor.o: /cygdrive/C/eclipse/workspace/HouseHeatSystem/tempsensor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
transduc.o: /cygdrive/C/eclipse/workspace/HouseHeatSystem/transduc.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
controller.o: \
 /cygdrive/C/eclipse/workspace/HouseHeatSystem/controller.cpp \
 /cygdrive/C/eclipse/workspace/HouseHeatSystem/controller.h \
...
generat.o: /cygdrive/C/eclipse/workspace/HouseHeatSystem/generat.cpp \
 /cygdrive/C/eclipse/workspace/HouseHeatSystem/generat.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/distri.h
heater.o: /cygdrive/C/eclipse/workspace/HouseHeatSystem/heater.cpp \
 /cygdrive/C/eclipse/workspace/HouseHeatSystem/heater.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
...
register.o: /cygdrive/C/eclipse/workspace/HouseHeatSystem/register.cpp \
 ...
 /cygdrive/C/eclipse/workspace/HouseHeatSystem/generat.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/workspace/HouseHeatSystem/transduc.h \
 /cygdrive/C/eclipse/workspace/HouseHeatSystem/tempsensor.h \
 /cygdrive/C/eclipse/workspace/HouseHeatSystem/controller.h \
 /cygdrive/C/eclipse/workspace/HouseHeatSystem/heater.h
tempsensor.o: \
 /cygdrive/C/eclipse/workspace/HouseHeatSystem/tempsensor.cpp \
 /cygdrive/C/eclipse/workspace/HouseHeatSystem/tempsensor.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
